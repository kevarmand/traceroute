...
#define TRACEROUTE_MAX_SIM_QUERIES 1024
...
static const t_arg_spec	g_traceroute_specs[] = {
	...
	{TRACEROUTE_OPT_SIM_QUERIES, 'N', NULL, 1},
	{TRACEROUTE_OPT_PROBES, 'q', NULL, 1},
	{TRACEROUTE_OPT_SOURCE, 's', NULL, 1},
	{TRACEROUTE_OPT_MAX_HOPS, 'm', NULL, 1},
	{TRACEROUTE_OPT_FIRST_TTL, 'f', NULL, 1},
	{TRACEROUTE_OPT_BASE_PORT, 'p', NULL, 1},
	{TRACEROUTE_OPT_SEND_WAIT, 'z', NULL, 1},
	{ARG_ID_END, 0, NULL, 0}
};
...
static int	set_value_error(t_traceroute_config *config,
	...
	config->cli.cli_error = ARG_ERR_INVALID_VALUE;
...
static int	set_cli_error(t_traceroute_config *config,
		const t_arg_result *result) {
	config->cli.error = TRACEROUTE_ARGS_CLI;
	config->cli.cli_error = result->error;
